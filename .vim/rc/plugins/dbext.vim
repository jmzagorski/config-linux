call dein#local('~/.cache/dein/repos/vim.org', {'on_ft':['sql']}, ['dbext'])
...
let g:dbext_default_profile_TSDSQLPROD = expand('type=SQLSRV:integratedlogin=1:srvname=$TSDSQLPROD')
